    ...
    void paintEvent(QPaintEvent *event) override {
        ...
        try {
            if (!isGameFinished) {
                ...
                painter.drawImage(QRect(player.x, player.y, player.width, player.height), QImage("/Users/kadir/OneDrive/Belgeler/HideAndSeek/images/pacman.png"))  ;
                ...
                // Oyuncuyu çizme p2
                 painter.drawImage(QRect(player2.x, player2.y, player2.width, player2.height), QImage("/Users/kadir/OneDrive/Belgeler/HideAndSeek/images/pacman2.png"))  ;
                ...
                for (const auto& ghost : ghosts ) {
                    if (!ghost.isHidden) {
                        ...
                        painter.drawImage(QRect(ghost.x, ghost.y,ghost.width, ghost.height), QImage("/Users/kadir/OneDrive/Belgeler/HideAndSeek/images/ghost.png"))  ;
